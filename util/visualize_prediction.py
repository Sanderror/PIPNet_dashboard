...
try:
    ...
    use_opencv = False
    print("Heatmaps showing where a prototype is found will not be generated because OpenCV is not installed.",
          flush=True)
        ...
        with torch.no_grad():
            ...
            for pred_class_idx in sorted_out_indices:
                ...
                for prototype_idx in sorted_pooled_indices:
                    simweight = pooled[0, prototype_idx].item() * net.module._classification.weight[
                    ...
                    if abs(simweight) > 0.01:
                        ...
                        str(f"{simweight:.3f}"), str(prototype_idx.item()),
                        ...
                        if use_opencv:
                            ...
                            softmaxes_resized = softmaxes_resized.resize((args.image_size, args.image_size),
                                                                         Image.BICUBIC)
                            ...
                            plt.imsave(fname=os.path.join(save_path, 'heatmap_p%s.png' % str(prototype_idx.item())),
