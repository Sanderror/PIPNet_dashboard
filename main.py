...
from util.data import get_dataloaders, load_image
...
def run_pipnet(args=None):
    ...
    print("WOWWW We are loading the dataaaa")
    ...
    # # print("start the pretraining phase")
    # # lrs_pretrain_net = []
    ...
    # #
    # # print("Start the real trianing phase")
    ...
    # print("i think training is done?")
    ...
    print("visualize the predictions or something")
    ...
    print("evaluate ood detection whatever that is")
